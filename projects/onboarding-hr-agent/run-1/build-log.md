...
4. **Timezone/day-boundary edge:** "days since start" uses local calendar dates; an SSR/client render straddling midnight could disagree by one day for one render. Accepted for a prototype; noted for engineering.
